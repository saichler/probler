...
echo "Building saichler/layer8-webui:${TAG} for ${PLATFORM}"
docker buildx build --no-cache --platform="$PLATFORM" -t saichler/layer8-webui:${TAG} .
docker push saichler/layer8-webui:${TAG}
