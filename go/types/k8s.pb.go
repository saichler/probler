...
type Pod struct {
	...
	ReadinessState string         `protobuf:"bytes,10,opt,name=readiness_state,json=readinessState,proto3" json:"readiness_state,omitempty"`
}
...
func (x *Pod) GetReadinessState() string {
	if x != nil {
...
var file_k8s_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x61, 0x64, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18,
	0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x72, 0x65, 0x61, 0x64, 0x69, 0x6e, 0x65, 0x73, 0x73,
	0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0xb8, 0x02, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x12,
