...
func main() {
	...
	res.Services().RegisterServiceHandlerType(&device_config.DeviceConfigServicePoint{})
	res.Services().RegisterServiceHandlerType(&poll_config.PollConfigServicePoint{})
	...
	nic.Resources().Services().Activate(device_config.ServicePointType, device_config.ServiceName, 0, nic.Resources(), nic)
