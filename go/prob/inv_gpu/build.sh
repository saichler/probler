...
echo "Building saichler/probler-inv-gpu:${TAG} for ${PLATFORM}"
docker buildx build --no-cache --platform="$PLATFORM" -t saichler/probler-inv-gpu:${TAG} .
docker push saichler/probler-inv-gpu:${TAG}
