...
echo "Building saichler/probler-orm:${TAG} for ${PLATFORM}"
docker buildx build --no-cache --platform="$PLATFORM" -t saichler/probler-orm:${TAG} .
docker push saichler/probler-orm:${TAG}
