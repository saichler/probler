...
function getAlarmsData() {
    return [
        ...
        { timestamp: '2025-10-01 14:28:42', severity: 'CRITICAL', device: 'DC2-GPU-NODE-47', type: 'GPU', message: 'Temperature threshold exceeded (92C)', location: 'Austin DC2 - Rack B08' },
        ...
        { timestamp: '2025-10-01 14:09:15', severity: 'WARNING', device: 'DC2-HVAC-UNIT-3', type: 'Cooling', message: 'Temperature rising (28C)', location: 'Austin DC2 - HVAC Zone 3' },
