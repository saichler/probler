...
func main() {
	...
	nic.Resources().ServicePoints().Activate(parsing.ServicePointType, "Parser-NetworkBox", 0, nic.Resources(), nic, &types.NetworkBox{}, "Id")
	...
	//as the NetworkBox
	nic.Resources().ServicePoints().Activate(parsing.ServicePointType, "Parser-Cluster", 1, nic.Resources(), nic, &types2.Cluster{}, "Name")
