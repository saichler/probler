...
echo "Building saichler/probler-admission:${TAG} for ${PLATFORM}"
docker buildx build --no-cache --platform="$PLATFORM" -t saichler/probler-admission:${TAG} .
docker push saichler/probler-admission:${TAG}
