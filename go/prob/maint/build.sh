...
echo "Building saichler/probler-maint:${TAG} for ${PLATFORM}"
docker buildx build --no-cache --platform="$PLATFORM" -t saichler/probler-maint:${TAG} .
docker push saichler/probler-maint:${TAG}
